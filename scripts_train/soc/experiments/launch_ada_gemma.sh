...
BASIC_CONFIG="scripts_train/soc/experiments_config/ada_gemma-2b/ada_gemma_ft_dist_conifg_2_h100_96.yaml"
# TRAIN_SCRIPT="scripts_train/soc/run_dist_train.sh"  # for MIG training
# BASIC_CONFIG="scripts_train/soc/experiments_config/ada_gemma-2b/ada_gemma_ft_dist_conifg_4_h100_47.yaml"

# ========== Single Test ==========
# TEST_CONFIG="scripts_train/soc/experiments_config/ada_gemma-2b/hp_grid/dora_svd_dim_512.yaml"
# TEST_CONFIG="scripts_train/soc/experiments_config/ada_gemma-2b/hp_grid/lora_svd_dim_512.yaml"
# bash "$TRAIN_SCRIPT" "$BASIC_CONFIG" "$TEST_CONFIG"

# ========== HyperParmeter Grid Search ==========
# Define the directory containing YAML files
YAML_DIR="scripts_train/soc/experiments_config/ada_gemma-2b/hp_grid/"  # DIR must end with "/"
