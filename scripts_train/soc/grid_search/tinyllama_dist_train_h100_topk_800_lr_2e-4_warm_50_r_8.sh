...
WANDB_RUN_NAME="tinyllama_topk_800_lr_2e-4_warm_50_r_8"  # about 0.03 warmup ratio
MODEL_DIR="base_models/ada-tinyllama-chat-empty_ada_r_8"
TOKENIZER_DIR="base_models/ada-tinyllama-chat-empty_ada_r_8"
