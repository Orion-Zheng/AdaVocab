...
model_1 = AutoModelForCausalLM.from_pretrained("experiment_models/tinyllama_expanded_empty",
                                               torch_dtype=torch.bfloat16)
model_2 = AutoModelForCausalLM.from_pretrained("experiment_ckpts/tinyllama_expanded_frez_embed-2024-04-10-211308/checkpoint-20",
                                               torch_dtype=torch.bfloat16)
